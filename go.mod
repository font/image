...
require (
	...
	github.com/open-policy-agent/opa v0.29.1 // indirect
	...
	github.com/sigstore/cosign v0.4.1-0.20210528210847-0b839264a5a2
	github.com/sigstore/rekor v0.1.2-0.20210519014330-b5480728bde6 // indirect
